...
//		exit;
		...
		$coFields['request[customer][first_name]'] = $billing->getFirstname();
		$coFields['request[customer][last_name]'] = $billing->getLastname();
		$coFields['request[customer][city]'] = $billing->getCity();
		$coFields['request[customer][country]'] = $billing->getCountry();
		$coFields['request[customer][state]'] = $state_val;
		$coFields['request[customer][zip]'] = $billing->getPostcode();
		$coFields['request[customer][address]'] = $billing->getStreetFull();
		$coFields['request[customer][phone]'] = $billing->getTelephone();
		$coFields['request[customer][email]'] = $billing->getEmail();
